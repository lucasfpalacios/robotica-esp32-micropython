...
💻 Instalación y Uso
 ...
 2. Importar el archivo diagram.json y main.py en Wokwi.
 3. Iniciar la simulación.
 4. Interactuar con el sensor HC-SR04 para probar la lógica de detección.
...
El algoritmo principal utiliza un bucle de exploración que mapea ángulos de 0° a 180°. En cada paso, se calcula la distancia mediante la fórmula:
      ...
      $$distancia = \frac{tiempo \times 0.0343}{2}$$
